...
const RentalCharts: React.FC<RentalChartsProps> = ({ calculations, form }) => {
  return (
    <div className="bg-white rounded-xl shadow-lg p-6 border border-blue-100">
      ...
      <div className="space-y-3">
        <div className="flex justify-between items-center p-3 bg-teal-50 rounded">
          <span className="font-medium text-teal-900">Ingresos</span>
        ...
        <div className="flex justify-between items-center p-3 bg-pink-50 rounded">
          <span className="font-medium text-pink-900">Hipoteca</span>
          <span className="font-bold text-pink-900">
            -{new Intl.NumberFormat("es-ES").format(calculations.cuotaMensual)} €
          </span>
        </div>
        <div className="flex justify-between items-center p-3 bg-pink-50 rounded">
          <span className="font-medium text-pink-900">Gastos</span>
          <span className="font-bold text-pink-900">
